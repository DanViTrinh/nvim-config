...
_G.packer_plugins = {
  ...
  ["virtcolumn.nvim"] = {
    loaded = true,
    path = "C:\\Users\\Dan\\AppData\\Local\\nvim-data\\site\\pack\\packer\\start\\virtcolumn.nvim",
